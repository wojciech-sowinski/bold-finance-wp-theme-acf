		...
		<div class="container pt-5 pb-4">
					...
					<div class="mb-2">
						<?php if ($footer_logo_column_1): ?>
							<a href="<?php get_site_url() ?>">
								<img class="img-fluid pb-3" style="max-width: 200px"
									src="<?php echo esc_url($footer_logo_column_1['url']); ?>"
			...
			<div class="row pt-5 d-flex gap-2 gap-md-0">
					...
					<div class="col-12 col-md-6 d-flex gap-3 justify-content-center justify-content-md-start"
						...
						<?php while (have_rows('footer_info_bar_col_2', 'option')):
							...
							<?php if ($footer_info_bar_col_2_link): ?>
								...
								<a class="text-center text-md-start" style="font-size:14px !important;" title="<?php the_title() ?>"
				...
				<?php if (have_rows('footer_info_bar_col_3', 'option')): ?>
					<div class="col-12 col-md-3 d-flex align-items-end justify-content-center justify-content-md-start gap-2 "
						style="font-size:14px;">
						<?php while (have_rows('footer_info_bar_col_3', 'option')):
							...
							<?php if ($footer_info_bar_col_3_logo): ?>
								<span class="d-flex align-items-center">
									<a target="blank" href="https://innhouse.pl/">
